  ...
  return (
    <footer className="bg-lightLilac flex items-center">
      <div id="footer-images" className="flex flex-col">
        <img
          src="/webmanosalta/images/fullcolor1.png"
          id="mano-logo"
          alt="M.A.No"
        />
        <span>
          <img src="/webmanosalta/images/aacm.jpg" id="aacm-logo" alt="AACM" />
          <img src="/webmanosalta/images/asot.png" id="asot-logo" alt="ASOT" />
        </span>
      </div>
